...
ServiceReclamation fn = new ServiceReclamation();
    ...
    ServiceReponse f = new ServiceReponse();
      Reponse rep = new Reponse();
        ...
        //*************ajout reclamation*************
    /*  rec.setEmail("rym.baccouri@esprit.tn");
       rec.setMessage("rym baccouri");
       rec.setType("exercice");
     ...
     //************* delete rec////////////
      ...
      // fn.deleteReclamation(35);
       ...
       //********* reclamation get by id***********************
         ...
         // Reclamation r = fn.getBytype("coach");
     ...
     // f.deleteReponse(84);
        ...
        //EmailSender.sendEmailWithAttachments("rym.baccouri@esprit.tn", "test testtt ", "message");
          //exemple mail 
        // EmailSender.sendEmailWithAttachments("rym.baccouri@esprit.tn", "test testtt ", "message");
          
         // Reclamation r = new Reclamation(2, "rym.baccouri@esprit.tn", "Test", "bonjour ", "2022-04-11");
        //sendSMS(r);
